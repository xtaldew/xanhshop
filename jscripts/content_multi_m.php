...
<?php if ($image!=''){ echo '<img border="0" src="../'.$image.'" width="100"><br><br>Hinh (kich thuoc nho)';}?>
								</td>
								
								<td width="40%" align="center" class="smallfont">
<?php if ($image_large!=''){ echo '<img border="0" src="../'.$image_large.'" width="100"><br><br>Hinh (kich thuoc lon)';}?>
								</td>
								<td width="15%"></td>
							</tr>
							<?php }else{echo '<tr><td colspan="3" class="smallfont" align="center">Chua co hinh anh !</td></tr>';}?>
				...
				<tr>
					...
					<td width="1%" class="smallfont" align="center"></td>
					<td width="83%" class="smallfont">
						<input type="checkbox" name="chkStatus" value="on" <?php if ($status>0) echo 'checked' ?>>
					</td>
				</tr>
